...
<head>
    ...
    <link href="{{ asset('front_asset/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('front_asset/assets/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
    <link href="{{ asset('front_asset/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
    <link href="{{ asset('front_asset/assets/vendor/remixicon/remixicon.css') }}" rel="stylesheet">
    <link href="{{ asset('front_asset/assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center justify-content-lg-between">
            ...
            <li><a class="nav-link scrollto" href="/pengguna">Admin</a></li>
            @else
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('front_asset/assets/vendor/purecounter/purecounter.js') }}"></script>
    ...
    <script src="{{ asset('front_asset/assets/vendor/glightbox/js/glightbox.min.js') }}"></script>
    <script src="{{ asset('front_asset/assets/vendor/isotope-layout/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('front_asset/assets/vendor/swiper/swiper-bundle.min.js') }}"></script>
